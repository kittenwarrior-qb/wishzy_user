  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div className="space-y-6">
        <div className="p-6 rounded-xl shadow shadow-white transition flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <Button
            ...
            className="mt-3 sm:mt-0 py-1 px-3"
