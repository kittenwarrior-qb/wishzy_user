                ...
                <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                    <div className="p-4">
                        ...
                        <div className="space-y-3 max-h-64 overflow-y-auto">
                            {cartItems.map((item) => (
                                <div key={item._id} className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded">
                                    <Image 
                                        src={item.thumbnail} 
                                        alt={item.courseName}
                                        width={48}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-400 truncate">{item.grade.gradeName} - {item.subject.subjectName}</p>
